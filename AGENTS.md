...
rake contacts:reid    # Move contacts whose ids are not server-minted
...
struck, and this book's groups as boxes to tick — before the lot is
landed through the store, into a group made for the import and
whichever groups each contact was given
